...
if __name__ == "__main__":
    ...
    #print(test_maze2)
    #print(test_maze2.index(0, 1))
    print(test_maze3.robotloc)

    #print(test_maze2.is_floor(2, 3))
    #print(test_maze2.is_floor(-1, 3))
    #print(test_maze2.is_floor(1, 0))
    #print(test_maze2.has_robot(1, 0))
    #print(test_maze2.is_wall(0, 0))
    #print(test_maze2.is_wall(1, 3))
